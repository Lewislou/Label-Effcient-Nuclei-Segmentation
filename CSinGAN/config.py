...
def get_arguments():
    ...
    parser.add_argument('--input_dir', help='input image dir', default='CSinGAN/')
    parser.add_argument('--input_name', help='input image name',default='train.png')
    parser.add_argument('--mask_name', help='input mask name',default='train_mask.png')
    ...
    parser.add_argument('--min_size',type=int,help='image minimal size at the coarser scale',default=128)
