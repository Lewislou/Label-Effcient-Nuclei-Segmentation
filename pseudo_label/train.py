...
#COCO_WEIGHTS_PATH = "mask_rcnn_nucleus_0.h5"
# Directory to save logs and model checkpoints, if not provided
# through the command line argument --logs
DEFAULT_LOGS_DIR = os.path.join(SAVE_DIR, "logs1")
...
TRAIN_IMAGE_IDS = [
    'TCGA-18-5592-01Z-00-DX1_0',
    'TCGA-A7-A13E-01Z-00-DX1_0',
    'TCGA-B0-5711-01Z-00-DX1_0',
    'TCGA-G9-6336-01Z-00-DX1_0',
...
class NucleusDataset(utils.Dataset):
    ...
    def load_nucleus(self, dataset_dir, subset):
        ...
        subset_dir = "seed21" if subset in ["train", "val"] else subset
        ...
        if subset == "stage1_test":
            ...
            for image_id in image_ids:
                self.add_image(
                    "nucleus",
                    image_id=image_id,
                    path=os.path.join(dataset_dir, image_id, "images/cell.png"))
